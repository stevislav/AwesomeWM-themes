...
local theme                                     = {}
theme.confdir                                   = os.getenv("HOME") .. "/.config/awesome/themes/deus"
...
local mytextclock = wibox.widget.textclock(markup("#d0902f", "%A %d %B ") .. markup("#d0902f", ">") .. markup("#d0902f", " %H:%M "))
...
local cpu = lain.widget.cpu({
    settings = function()
        widget:set_markup(markup.fontfg(theme.font, "#fdd870", cpu_now.usage .. "% "))
    end
})
...
theme.volume = lain.widget.alsa({
    settings = function()
        ...
        widget:set_markup(markup.fontfg(theme.font, "#d0902f", volume_now.level .. "% "))
    end
})
...
local netupinfo = lain.widget.net({
    settings = function()
        ...
        netdowninfo:set_markup(markup.fontfg(theme.font, "#d0902f", net_now.received .. " "))
    end
})
...
local memory = lain.widget.mem({
    settings = function()
        widget:set_markup(markup.fontfg(theme.font, "#a15501", mem_now.used .. "M "))
    end
})
